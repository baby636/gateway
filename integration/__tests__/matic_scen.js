...
buildScenarios('Matic', lock_scen_info, [
    {
        ...
        scenario: async ({ashley, usdc, darlene, maticZrx }) => {
            ...
            await darlene.lock(100, maticZrx);balance = await darlene.balanceForToken(maticZrx);
    ...
    },
    {
        ...
        scenario: async ({ darlene, chuck, cash, chain, usdc, maticZrx, zrx, prices }) => {
            ...
            // xxx todo:wn this test is broken but so is its friend, interest is accruing even though time is not "on"
    ...
    },
    {
        ...
        only: true,
        scenario: async ({ darlene, maticZrx, usdc, chain, maticStarport }) => {
            let balance, liquidity;
